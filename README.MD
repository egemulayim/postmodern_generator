...
The generator currently supports the following thematic clusters:
...
Each theme is designed to produce essays with a distinct theoretical focus, drawing on relevant philosophers, concepts, and terminology.
